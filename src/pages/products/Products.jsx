          ...
          <div className="productContainerList">
              ...
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    ...
                    IFMASA leaders, sharing their experiences and perspectives
              ...
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    ...
                    highlighting collaborative projects and scholarly
                    discussions among IFMASA members, focusing on the value of
            ...
            <div className="productContainerListItem">
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    Essays on Social Impact and Transformation" - A collection
                    of thought-provoking essays written by IFMASA members,
                    examining critical social issues and proposing innovative
              ...
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    ...
                    members who have embarked on entrepreneurial ventures or
                    made significant contributions in the field of technology.
                  </p>
                  <div className="rating">
                    <span>
                      <i className="star fa-solid fa-star"></i>
            ...
            <div className="productContainerListItem">
              <div className="containerImage">
                ...
                />
                <div className="containerOverlay">
                  <h2>Advancing Research</h2>
                  <p>
                    Breakthroughs in Science and Technology" - A publication
                    highlighting cutting-edge research projects undertaken by
                    IFMASA members, focusing on advancements in various
                    scientific fields.
                  </p>
                  <div className="rating">
                    <span>
            ...
            <div className="productContainerListItem">
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    Innovations in Teaching and Learning" - A book presenting
                    innovative teaching methods, educational projects, and
                    pedagogical insights from IFMASA members, aiming to enhance
                    the learning experience and promote educational excellence.
                  </p>
                  <div className="rating">
                    <span>
                      <i className="star fa-solid fa-star"></i>
            ...
            <div className="productContainerListItem">
              <div className="containerImage">
                ...
                <div className="containerOverlay">
                  ...
                  <p>
                    Strategies for Social and Environmental Sustainability" - A
                    publication featuring case studies, research papers, and
                    articles authored by IFMASA members, focusing on sustainable
